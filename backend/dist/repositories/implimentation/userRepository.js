...
let userRepository = class userRepository extends baseRepository_1.BasRepository {
    constructor() {
    ...
    finduserByRole(role) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield userModel_1.User.find({ role: role }, '-password');
            }
            catch (error) {
                (0, logger_utils_1.logError)(error);
    ...
    usersByGender() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield userModel_1.User.aggregate([
                    { $facet: {
