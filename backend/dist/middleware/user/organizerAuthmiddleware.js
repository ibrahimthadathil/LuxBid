...
exports.OrganizerAuthMiddleware = void 0;
...
const OrganizerAuthMiddleware = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!token)
            ...
            if (!role) {
                const currentuser = yield userModel_1.User.findById(organizerId);
