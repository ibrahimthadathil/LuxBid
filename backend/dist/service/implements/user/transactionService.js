...
let transactionService = class transactionService {
    ...
    getHistoryByuser(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield this.transactionRepo.getUserTransactionHistory(userId);
                if (response)
                ...
                return { success: false, message: http_StatusCode_1.responseMessage.INTERNAL_ERROR };
            }
        });
    }
};
