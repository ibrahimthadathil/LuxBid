...
adminRoute.delete('/categoryremove/:id',categoryController.Category_Remove.bind(categoryController))
adminRoute.put('/categoryupdate/:id',categoryController.category_update.bind(categoryController))
