...
authRoute.post('/forget/password',authController.forgetPassword.bind(authController))
authRoute.post('/reset/otp',authController.resetOTP.bind(authController))
authRoute.post('/reset/password',authController.resetPassword.bind(authController))
