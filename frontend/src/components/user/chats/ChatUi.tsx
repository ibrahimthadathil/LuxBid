                ...
                return (
                  ...
                  >
                    <div className="relative flex items-center group">
                      ...
                      <div
                        className={`max-w-xs md:max-w-md lg:max-w-lg xl:max-w-xl rounded-lg z-0  p-2 relative mb-2 ${
                          message.user?.firstName === userName
                            ? "bg-zinc-800 text-gray-300 border"
                            : "bg-zinc-950 text-white-800 border"
                        }`}
                      >
                        ...
                        {message.replyTo && (
                          <div className="bg-zinc-900 border-l-2 border-indigo-500 pl-2 mb-1 text-sm text-gray-600 rounded flex items-start">
                            <div className="flex-1">
                              <p className="font-semibold text-xs text-indigo-600">
                                {message.replyTo?.user?.firstName === userName
                                  ? "You"
                              ...
                              message.replyTo.attachments.length > 0 ? (
                                <div className="grid grid-cols-2 gap-1 mt-1">
                                  {message.replyTo.attachments.map(
                                    (attachment, index) =>
                                      isImageUrl(attachment) ? (
                                        <div
                                          key={index}
                                          className="w-16 h-16 rounded-md overflow-hidden border border-zinc-700"
                                        >
                                          <img
                                            src={attachment}
                            ...
                            <div className="mt-1 grid grid-cols-2 gap-2">
                              {message.attachments.map((attachment, index) =>
                                isImageUrl(attachment) ? (
                                  ...
                                  <div
                                    key={index}
                                    className="rounded-md border border-gray-300 bg-gray-100 p-2 flex items-center justify-center"
                                  >
                        ...
                        {message.emojis && message.emojis.length > 0 && (
                          <div className="absolute bottom-0 p-1 bg-transparent left-0 transform translate-x-0 translate-y-1/2 flex items-center z-10">
                            {message.emojis.map((emojiObj) => (
                              <span
                                key={emojiObj._id}
                                className="bg-zinc-900  rounded-full px-1 py-1 text-sm flex items-center space-x-1"
                              >
