      ...
      <div className="max-w-3xl mx-auto">
        <div className="mb-6 sm:mb-8">
          <p className="text-xs sm:text-sm text-gray-400">
            Our Capital, Your <span className="text-purple-400">Success</span>
          </p>
          <h1 className="mt-2 text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight">
            ...
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-purple-600">Firm</span>
          </h1>
          <h2 className="mt-2 text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight">
            <span className="text-white">Conquer The </span>
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-purple-600">market</span>
          </h2>
        </div>

        <Button className="mt-6 sm:mt-8 bg-purple-600 hover:bg-purple-700">
