    ...
    <div className="flex flex-col lg:flex-row h-full w-full">
      ...
      <div className="lg:w-[50%] w-full flex justify-center pt-16 lg:pt-[7rem] px-4 lg:ps-[4rem]">
        <div className="w-full max-w-md flex flex-col items-center text-[#7b7575] text-center">
          ...
          />
           <p className="">
           <Link to="/auth/forgot-password" className=" text-sm text-zinc-600 ">
                Forgot Password?
            </Link>
           </p>
          <button type="submit" className="w-[85%]  sm:w-[65%] mt-2 text-white p-2 rounded-md bg-zinc-800">
            Continue
          </button>
          </form><br />
          <h6>Don't have an account?<span className="text-white ps-1 font-light"><Link to={'/auth/signup'}>SignUp</Link></span></h6>
        </div>
      </div>
    </div>
  );
